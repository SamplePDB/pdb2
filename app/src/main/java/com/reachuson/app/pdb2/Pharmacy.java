    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                user muser = new user();
                muser.setName(Name);
                muser.setInstname(retail);
                muser.setpin(pincoce);
                muser.setstate(State);

                if(mdb.getReference(userID).child("Info").setValue(muser).isSuccessful()){
                    Toast.makeText(Pharmacy.this, "User Information Created!", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(Pharmacy.this,Home.class);
                    startActivity(i);
                }
                else {
                    Toast.makeText(Pharmacy.this, "Please try again!", Toast.LENGTH_SHORT).show();
                }
            }
        });
